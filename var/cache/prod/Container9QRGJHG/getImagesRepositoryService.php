...
class getImagesRepositoryService extends App_KernelProdContainer
{
    ...
    {
        return $container->privates['App\\Repository\\ImagesRepository'] = new \App\Repository\ImagesRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
